...
### 4. ~~Улучшенные мотыги (Enhanced Hoes)~~ ✅ РЕАЛИЗОВАНО
~~**Описание:** Разные мотыги дают разное количество дропа при сборе урожая~~
- ✅ Бонусный дроп для всех типов мотыг
- ✅ Настраиваемые множители
- ✅ Поддержка всех культур

### 5. Зачарование "Автопосадка" (Auto Replant)
...
### 6. ~~Балансировка коров (Cow Milking Balance)~~ ✅ РЕАЛИЗОВАНО
~~**Описание:** Ограничение на доение коров для предотвращения фарма~~
- ✅ Кулдаун между доениями
- ✅ Ускорение через кормление пшеницей
- ✅ Визуальные индикаторы готовности
- ✅ NBT теги для персистентности
```yaml
cow-milking:
  enabled: true
...
3. ~~**Средний:** Map Locking (защита мапартов)~~ ✅ ГОТОВО
4. ~~**Средний:** Frame Locking (защита от гриферов)~~ ✅ ГОТОВО
5. ~~**Средний:** Enhanced Bone Meal (порт с Bedrock)~~ ✅ ГОТОВО
6. ~~**Средний:** Anvil Repair (экономия ресурсов)~~ ✅ ГОТОВО
7. ~~**Низкий:** Name Tag Removal (QoL фича)~~ ✅ ГОТОВО
8. ~~**Низкий:** Enhanced Hoes~~ ✅ ГОТОВО
9. ~~**Низкий:** Cow Milking Balance~~ ✅ ГОТОВО
10. **Низкий:** Auto Replant (опционально)
