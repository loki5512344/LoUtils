...
public class VillagerLeashListener extends BaseListener {
    ...
    public void onPlayerLeashEntity(PlayerLeashEntityEvent event) {
        ...
        boolean leashEnabled = moduleConfig().getBoolean("leash-enabled", true);
    ...
    public void onPlayerInteractEntity(PlayerInteractEntityEvent event) {
        ...
        if (!moduleConfig().getBoolean("emerald-attraction.enabled", true)) return;
        
        double speed = moduleConfig().getDouble("emerald-attraction.movement-speed", GameplayConstants.VILLAGER_MOVEMENT_SPEED);
